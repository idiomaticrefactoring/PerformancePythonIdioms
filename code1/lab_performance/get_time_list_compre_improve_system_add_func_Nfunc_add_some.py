...
def save_one_file_time_list(file_name, code_list, iterations):
...
if __name__ == '__main__':
    ...
    log_time_complicate_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks_fun_and_Nfunc_once_again/log/log_time_list_compreh_compli_code_prefined_cpu_new/"
    ...
    log_time_simp_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks_fun_and_Nfunc_once_again/log/log_time_list_compreh_simp_code_prefined_cpu_new/"
    ...
    time_complicate_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks_fun_and_Nfunc_once_again/code/time_complicated_code_prefined_cpu_new/"
    time_simp_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks_fun_and_Nfunc_once_again/code/time_simple_code_prefined_cpu_new/"

    # util.mkdirs(time_complicate_bench_dir)
    # util.mkdirs(time_simp_bench_dir)
    bench_time_info_dir=util.data_root + "lab_performance/list_compre_benchmarks_fun_and_Nfunc_once_again/prefined_cpus_remain_code_new/"
    ...
    prefined_cpu = "taskset -c 2,3 "#"taskset -c 4,5 "
    ...
    again_file_name_list=["1_3_4_list(range(1,11))_func.py","1_4_0_[].py",
                          "1_4_3_list(range(1,11))_func.py","2_2_1_[].py",
                          "2_4_1_list(range(1,33))_func.py","4_2_3_list(range(1,4))_func.py",
                         "4_3_0_list(range(1,3))_func.py","4_4_3_list(range(1,7))_func.py" ]
    ...
    for file_name in dir_list[:]:#9001750
        # if file_name not in again_file_name_list:
        #     continue

        if file_name!="1_0_0_list(range(1,10001))_func.py":
            continue
        ...
        #     continue
        # flag_filter=0
        # for filter_file_name in filter_file_name_list:
        ...
        for ind, (for_node, assign_node, remove_ass_flag, new_tree) in enumerate(code_list):
            ...
            #     continue
            count_remain+=1
        save_one_file_time_list(file_name, code_list, iterations)
