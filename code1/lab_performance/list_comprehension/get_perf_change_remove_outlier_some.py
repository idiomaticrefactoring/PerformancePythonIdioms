...
if __name__ == '__main__':
    ...
    save_code_info_dir_add_performance_change=\
        util.data_root + "lab_performance/list_compre_benchmarks_fun_and_Nfunc/prefined_cpus_remain_code_new_add_perf_change/"
    save_code_info_dir_add_performance_change = \
        util.data_root + "lab_performance/list_compre_benchmarks_fun_and_Nfunc/prefined_cpus_remain_code_new_add_perf_change_remove_outlier/"
    save_code_info_dir_add_performance_change = \
        util.data_root + "lab_performance/list_compre_benchmarks_fun_and_Nfunc_once_again/prefined_cpus_remain_code_new_add_perf_change_remove_outlier/"
    ...
    for ind, file_name in enumerate(sorted(os.listdir(bench_time_info_dir)[:])):
        ...
        # break
        if file_name[:-4]!="1_0_0_list(range(1,10001))_func":
            continue
