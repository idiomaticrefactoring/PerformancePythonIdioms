...
print("roc_auc_score(Y_test, Y_pred)",roc_auc_score(Y_test, Y_pred))
# '''
...
#https://www.aiuai.cn/aifarm1938.html remove blank area
plt.savefig("performance_rq1_list_compre.pdf", format="pdf", bbox_inches="tight",pad_inches=0)
