...
if __name__ == '__main__':
    ...
    prefined_cpu = "taskset -c 11 "#"taskset -c 6,7 "
    ...
    # print(len(dir_list))
    again_file_list=['1_0_0_list(range(1,100001)).py', '1_0_0_list(range(1,100001))_func.py', '1_0_2_list(range(1,100001)).py',
     '1_0_2_list(range(1,100001))_func.py', '1_0_2_list(range(1,1001)).py', '1_0_2_list(range(1,11)).py',
     '1_0_3_list(range(1,1000001)).py', '1_0_3_list(range(1,100001)).py', '1_0_3_list(range(1,100001))_func.py',
     '1_0_4_[].py', '1_0_4_list(range(1,1000001)).py', '1_0_4_list(range(1,11)).py', '1_0_4_list(range(1,11))_func.py',
     '1_1_0_[].py', '1_1_1_list(range(1,1000001)).py', '1_1_2_list(range(1,100001))_func.py',
     '1_1_2_list(range(1,1001)).py', '1_1_3_list(range(1,100001)).py', '1_1_3_list(range(1,1001)).py',
     '1_2_0_[1]_func.py', '1_2_0_[].py', '1_2_0_list(range(1,100001)).py', '1_2_1_list(range(1,100001)).py',
     '1_2_1_list(range(1,101)).py', '1_2_2_list(range(1,100001)).py', '1_2_2_list(range(1,100001))_func.py',
     '1_2_2_list(range(1,11))_func.py', '1_2_3_list(range(1,100001)).py', '1_2_3_list(range(1,100001))_func.py',
     '1_2_4_list(range(1,100001)).py', '1_2_4_list(range(1,101)).py', '1_3_0_list(range(1,101)).py', '1_3_1_[1].py',
     '1_3_1_[]_func.py', '1_3_1_list(range(1,100001)).py', '1_3_1_list(range(1,10001))_func.py',
     '1_3_2_list(range(1,100001)).py', '1_3_3_list(range(1,100001)).py', '1_3_3_list(range(1,100001))_func.py',
     '1_3_3_list(range(1,10001)).py', '1_3_3_list(range(1,11)).py', '1_3_4_list(range(1,101)).py',
     '1_3_4_list(range(1,11)).py', '1_4_0_list(range(1,100001)).py', '1_4_0_list(range(1,11)).py', '1_4_2_[1].py',
     '1_4_2_list(range(1,1000001)).py', '1_4_2_list(range(1,100001)).py', '1_4_3_list(range(1,100001))_func.py',
     '1_4_3_list(range(1,11)).py', '1_4_4_list(range(1,100001)).py', '1_4_4_list(range(1,100001))_func.py',
     '1_4_4_list(range(1,10001))_func.py', '2_0_0_list(range(1,101)).py', '2_0_2_list(range(1,101)).py',
     '2_0_2_list(range(1,317))_func.py', '2_0_3_list(range(1,101))_func.py', '2_0_4_list(range(1,101)).py',
     '2_0_4_list(range(1,317)).py', '2_1_0_[1].py', '2_1_1_[1].py', '2_1_1_list(range(1,317)).py',
     '2_1_1_list(range(1,317))_func.py', '2_1_2_[].py', '2_1_3_list(range(1,101)).py',
     '2_1_3_list(range(1,317))_func.py', '2_1_4_list(range(1,11)).py', '2_2_0_list(range(1,317)).py',
     '2_2_1_[]_func.py', '2_2_1_list(range(1,317)).py', '2_2_1_list(range(1,317))_func.py', '2_2_2_[]_func.py',
     '2_2_2_list(range(1,317)).py', '2_2_2_list(range(1,4))_func.py', '2_2_3_[]_func.py',
     '2_2_3_list(range(1,317))_func.py', '2_2_4_list(range(1,317)).py', '2_3_3_list(range(1,33))_func.py',
     '2_3_3_list(range(1,4)).py', '2_4_0_[1].py', '2_4_1_[]_func.py', '2_4_2_list(range(1,101))_func.py',
     '2_4_3_list(range(1,317)).py', '2_4_4_[].py', '2_4_4_list(range(1,317)).py', '3_0_0_list(range(1,47))_func.py',
     '3_0_2_[1].py', '3_0_2_list(range(1,47)).py', '3_0_2_list(range(1,47))_func.py', '3_0_3_[1]_func.py',
     '3_0_3_list(range(1,47))_func.py', '3_0_4_list(range(1,47)).py', '3_0_4_list(range(1,47))_func.py',
     '3_1_0_list(range(1,3)).py', '3_1_0_list(range(1,47))_func.py', '3_1_2_list(range(1,23))_func.py',
     '3_1_3_list(range(1,47))_func.py', '3_1_4_[].py', '3_1_4_list(range(1,11)).py', '3_2_0_list(range(1,3)).py',
     '3_2_0_list(range(1,47)).py', '3_2_0_list(range(1,47))_func.py', '3_2_1_list(range(1,47))_func.py',
     '3_2_2_list(range(1,47)).py', '3_2_3_list(range(1,11))_func.py', '3_2_3_list(range(1,23))_func.py',
     '3_2_4_[1]_func.py', '3_3_1_[].py', '3_3_1_list(range(1,47))_func.py', '3_3_2_list(range(1,47))_func.py',
     '3_3_3_list(range(1,47))_func.py', '3_3_4_list(range(1,47))_func.py', '3_4_0_[1].py',
     '3_4_0_list(range(1,23))_func.py', '3_4_1_list(range(1,47))_func.py', '3_4_2_[1].py', '3_4_2_list(range(1,11)).py',
     '3_4_2_list(range(1,47)).py', '3_4_4_list(range(1,11)).py', '4_0_0_[1].py', '4_0_0_list(range(1,19)).py',
     '4_0_2_[1]_func.py', '4_0_2_list(range(1,19))_func.py', '4_0_3_list(range(1,11)).py', '4_0_4_list(range(1,19)).py',
     '4_0_4_list(range(1,19))_func.py', '4_1_0_list(range(1,19)).py', '4_1_0_list(range(1,19))_func.py',
     '4_1_1_list(range(1,19))_func.py', '4_1_1_list(range(1,3)).py', '4_1_1_list(range(1,4))_func.py', '4_1_2_[1].py',
     '4_1_2_list(range(1,11)).py', '4_1_3_list(range(1,11)).py', '4_1_3_list(range(1,19))_func.py',
     '4_1_4_list(range(1,4))_func.py', '4_2_0_list(range(1,19)).py', '4_2_1_[1]_func.py', '4_2_1_list(range(1,19)).py',
     '4_2_1_list(range(1,7))_func.py', '4_2_2_list(range(1,19)).py', '4_2_3_[].py', '4_2_3_list(range(1,19))_func.py',
     '4_2_4_list(range(1,11)).py', '4_3_0_list(range(1,11))_func.py', '4_3_0_list(range(1,7))_func.py',
     '4_3_1_list(range(1,19))_func.py', '4_3_4_list(range(1,19)).py', '4_4_0_list(range(1,19)).py',
     '4_4_0_list(range(1,19))_func.py', '4_4_2_list(range(1,11))_func.py', '4_4_2_list(range(1,19)).py',
     '4_4_3_list(range(1,11))_func.py', '4_4_4_[1]_func.py', '4_4_4_list(range(1,11)).py']
    ...
    for file_name in dir_list[:]:
        ...
        # print(file_name)
        invocations = 50
        # if "1_2_1_list(range(1,101)).py"!=file_name:#1_2_1_list(range(1,101)).py 1_0_0_list(range(1,1001)).py
        #     continue
        if file_name not in again_file_list:
            continue
