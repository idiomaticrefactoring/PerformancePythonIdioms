...
if __name__ == '__main__':
    ...
    log_time_complicate_bench_dir = util.data_root_mv + "lab_performance/for_else_benchmarks/log/log_time_compli_code_prefined_cpu_new/"
    ...
    log_time_simp_bench_dir = util.data_root_mv + "lab_performance/for_else_benchmarks/log/log_time_simp_code_prefined_cpu_new/"
    ...
    time_complicate_bench_dir = util.data_root_mv + "lab_performance/for_else_benchmarks/code/time_complicated_code_prefined_cpu_new/"
    time_simp_bench_dir = util.data_root_mv + "lab_performance/for_else_benchmarks/code/time_simple_code_prefined_cpu_new/"

    # util.mkdirs(time_complicate_bench_dir)
    # util.mkdirs(time_simp_bench_dir)
    bench_time_info_dir=util.data_root_mv + "lab_performance/for_else_benchmarks/bench_time_info_dir_prefined_cpu_new/"
