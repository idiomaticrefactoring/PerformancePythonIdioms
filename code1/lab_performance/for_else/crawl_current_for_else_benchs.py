...
from extract_idiom_for_else import get_idiom_for_else
...
if __name__ == '__main__':
    ...
    csv_chain_compare_idiom=util.data_root + "lab_performance/csv/csv_for_else_idiom.csv"
    # repo_list = []
