...
if __name__ == '__main__':
    ...
    log_time_complicate_bench_dir = util.data_root_mv + "lab_performance/for_else_benchmarks_some_once_again_new/log/log_time_compli_code_prefined_cpu_new/"
    ...
    log_time_simp_bench_dir = util.data_root_mv + "lab_performance/for_else_benchmarks_some_once_again_new/log/log_time_simp_code_prefined_cpu_new/"
    ...
    time_complicate_bench_dir = util.data_root_mv + "lab_performance/for_else_benchmarks_some_once_again_new/code/time_complicated_code_prefined_cpu_new/"
    time_simp_bench_dir = util.data_root_mv + "lab_performance/for_else_benchmarks_some_once_again_new/code/time_simple_code_prefined_cpu_new/"
    ...
    offset=74
    file_name_list=[
        "100000_inputNum_while_nodeKind_1_break_0_else_func.py",
        "10000_inputNum_while_nodeKind_0_break_0_else_func.py",
        "10000_inputNum_while_nodeKind_0_break_1_else_func.py",
        "1000_inputNum_while_nodeKind_1_break_0_else_func.py",
        "10_inputNum_for_nodeKind_1_break_1_else_func.py"
    ]
    file_name_list = [
    "10000_inputNum_while_nodeKind_0_break_0_else_func.py"]
...
#         break
        ...
        #     fileget_time_for_else_add_func_Nfunc_some_once_again.py_path = bench_dir + file_name
        #     # if os.path.exists(bench_time_info_dir+file_name[:-3]+".pkl"):
        #     #     continue
        #     count_remain+=1
