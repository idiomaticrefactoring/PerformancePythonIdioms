...
if __name__ == '__main__':
    ...
    log_time_complicate_bench_dir = util.data_root_mv + "lab_performance/for_else_benchmarks/log/log_time_compli_code_prefined_cpu_new_once_again/"
    ...
    log_time_simp_bench_dir = util.data_root_mv + "lab_performance/for_else_benchmarks/log/log_time_simp_code_prefined_cpu_new_once_again/"
    ...
    time_complicate_bench_dir = util.data_root_mv + "lab_performance/for_else_benchmarks/code/time_complicated_code_prefined_cpu_new_once_again/"
    time_simp_bench_dir = util.data_root_mv + "lab_performance/for_else_benchmarks/code/time_simple_code_prefined_cpu_new_once_again/"

    # util.mkdirs(time_complicate_bench_dir)
    # util.mkdirs(time_simp_bench_dir)
    bench_time_info_dir=util.data_root_mv + "lab_performance/for_else_benchmarks/bench_time_info_dir_prefined_cpu_new_once_again/"
    ...
    for ind,file_name in enumerate(dir_list[:]):#9001750
        # if "1000000" not in file_name:
        #     continue
        if "10000_inputNum_for_nodeKind_1_break_0_else.py" not in file_name:
            continue
        print(file_name)
        # if ind>3:
        #     break
