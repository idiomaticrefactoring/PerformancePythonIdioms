...
input_num_list=[0]+[10**i for i in range(7)]
threshold=10
    ...
    for node_kind in node_kind_list:
        ...
        for ind_branch,branch in enumerate(branch_list):
            for ind_else,else_body in enumerate(else_body_list):
                ...
                file_name = f"{input_num}_inputNum_{node_kind_name}_nodeKind_{ind_branch}_break_{ind_else}_else.py"
                # print("code_complicated_str: \n")
                # print(code_complicated_str)
                # print(file_name)
        ...
        # break
    # break
print("total code: ",file_name_list,all_file_name_list,count,len(file_name_list))
