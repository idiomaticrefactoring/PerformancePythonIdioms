...
if __name__ == '__main__':
    ...
    log_time_complicate_bench_dir = util.data_root_mv + "lab_performance/set_compre_benchmarks_once_again/log/log_time_compli_code_prefined_cpu_new/"
    ...
    log_time_simp_bench_dir = util.data_root_mv + "lab_performance/set_compre_benchmarks_once_again/log/log_time_simp_code_prefined_cpu_new/"
    ...
    time_complicate_bench_dir = util.data_root_mv + "lab_performance/set_compre_benchmarks_once_again/code/time_complicated_code_prefined_cpu_new/"
    time_simp_bench_dir = util.data_root_mv + "lab_performance/set_compre_benchmarks_once_again/code/time_simple_code_prefined_cpu_new/"

    # util.mkdirs(time_complicate_bench_dir)
    # util.mkdirs(time_simp_bench_dir)
    bench_time_info_dir=util.data_root_mv + "lab_performance/set_compre_benchmarks_once_again/prefined_cpus_remain_code_new/"
    # util.mkdirs(bench_time_info_dir)
    bench_dir = util.data_root_mv + "lab_performance/set_compre_benchmarks/code/code/"
    total_start_time=time.time()
    prefined_cpu = "taskset -c 5 "
    ...
    for file_name in dir_list[offset:end]:
