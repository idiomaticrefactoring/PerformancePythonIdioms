...
if __name__ == '__main__':
    ...
    bench_dir_no_idiomatic = util.data_root_mv + "lab_performance/set_compre_benchmarks_no_idiomatic/code/code/"

    total_start_time=time.time()
    prefined_cpu = "taskset -c 5  "#"taskset -c 7 "#"taskset -c 2,3 "
