...
def save_perf_change(file_name,bench_time_info_dir,save_code_info_dir_add_performance_change,invo=50):
    try:
        ...
        lab_code_info.get_performance_improve_info(step=100)
...
if __name__ == '__main__':
    ...
    csv_perf_change_dir=util.data_root + "lab_performance/set_compre_benchmarks_once_again_2/csv/"
    file_name_list=[]
    invo = 50
    count=0
    ...
    for ind, file_name in enumerate(sorted(os.listdir(bench_time_info_dir)[:])):
        ...
        count+=1
        save_perf_change(file_name, bench_time_info_dir, save_code_info_dir_add_performance_change, invo=50)
        # if ind>2:
        #     break
