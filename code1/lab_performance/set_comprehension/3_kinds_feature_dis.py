...
if __name__ == '__main__':
    ...
    dir_csv_feature=util.data_root_mv + "lab_performance/set_compre_benchmarks_once_again_2/csv/"
    csv_feature_file_name_corr= dir_csv_feature+"train_data_set_compre_2.csv"
