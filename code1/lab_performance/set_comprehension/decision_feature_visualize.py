...
'''
csv_feature_file_name_corr = util.data_root_mv + "lab_performance/set_compre_benchmarks_once_again_2/csv/train_data_set_compre_2.csv"
...
plt.savefig("performance_rq1_set_compre.pdf", format="pdf", bbox_inches="tight",pad_inches=0)
plt.show()
...
#https://scikit-learn.org/stable/modules/model_evaluation.html
#https://scikit-learn.org/stable/modules/generated/sklearn.tree.DecisionTreeClassifier.html#sklearn.tree.DecisionTreeClassifier.score
# score=cross_validate(clf, df[feature_names], df.target, scoring = ['f1_micro','f1_macro',myscore],cv=10)
