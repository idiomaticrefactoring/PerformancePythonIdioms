...
if __name__ == '__main__':
    ...
    csv_feature_file_name_corr_dir = util.data_root_mv + "lab_performance/set_compre_benchmarks_once_again_2/csv/"
    csv_feature_file_name_corr = csv_feature_file_name_corr_dir + "set_compre_lab_performance_features.csv"
