...
if __name__ == '__main__':
    ...
    log_time_complicate_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks/log/log_time_list_compreh_compli_code_complete/"
    ...
    log_time_simp_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks/log/log_time_list_compreh_simp_code/"
    ...
    time_complicate_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks/code/time_complicated_code_complete/"
    time_simp_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks/code/time_simple_code/"
