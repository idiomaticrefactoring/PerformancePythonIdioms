...
if __name__ == '__main__':
    ...
    log_time_complicate_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks/different_sys_set/log/log_time_list_compreh_compli_code_busy/"
    log_time_simp_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks/log/different_sys_set/log_time_list_compreh_simp_code_busy/"
    util.mkdirs(log_time_complicate_bench_dir)
    util.mkdirs(log_time_simp_bench_dir)
    time_complicate_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks/different_sys_set/code/time_complicated_code_busy/"
    time_simp_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks/different_sys_set/code/time_simple_code_busy/"

    util.mkdirs(time_complicate_bench_dir)
    util.mkdirs(time_simp_bench_dir)
    bench_time_info_dir=util.data_root + "lab_performance/list_compre_benchmarks/different_sys_set/code_time_info_busy/"
