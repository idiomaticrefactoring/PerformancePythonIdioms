...
if __name__ == '__main__':
    ...
    log_time_complicate_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks_10_7_add_func_test/log/log_time_list_compreh_compli_code_prefined_cpu/"
    ...
    log_time_simp_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks_10_7_add_func_test/log/log_time_list_compreh_simp_code_prefined_cpu/"
    ...
    time_complicate_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks_10_7_add_func_test/code/time_complicated_code_prefined_cpu/"
    time_simp_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks_10_7_add_func_test/code/time_simple_code_prefined_cpu/"
    ...
    bench_dir = util.data_root + "lab_performance/list_compre_benchmarks_10_7_add_func_test/code/code/"
    bench_dir = util.data_root + "lab_performance/list_compre_benchmarks_10_7_add_func_test/code/code/"
    ...
    for file_name in dir_list[:]:
        ...
        #     continue
        # if file_name!="1_0_0_[1]_func.py":#"1_1_0_list(range(1,11))*10.py":##"4_0_0_[1].py":#"1_1_0_list(range(1,11))*10.py":
        #     continue
