...
feature_names = ["num_assign_node","is_const","context","is_swap"]
...
X_train, X_test, Y_train, Y_test = train_test_split(df[feature_names], df['target'], test_size=0.15, random_state=1)
print(X_train)
