...
if __name__ == '__main__':
    ...
    save_code_info_dir_add_performance_change = \
        util.data_root + "lab_performance/multi_ass_benchmarks_30/prefined_cpus_remain_code_new_add_perf_change/"

    # save_code_info_dir_add_performance_change = \
    #     util.data_root + "lab_performance/multi_ass_benchmarks_some_again/prefined_cpus_remain_code_new_add_perf_change/"
    ...
    filter_file_name_list = [
        ...
        '8_ass_var_func.pkl', '8_ass_swap_func.pkl', '4_ass_var_func.pkl', '9_ass_swap_func.pkl'
    ]
    for ind, file_name in enumerate(sorted(os.listdir(bench_time_info_dir)[:])):
        # print("file_name: ",file_name)
        # break
        # if file_name not in filter_file_name_list:
        #     continue
