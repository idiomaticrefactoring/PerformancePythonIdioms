...
if __name__ == '__main__':
    ...
    log_time_complicate_bench_dir = util.data_root + "lab_performance/multi_ass_benchmarks/log/log_time_chain_compare_compli_code_prefined_cpu_new/"
    ...
    log_time_simp_bench_dir = util.data_root + "lab_performance/multi_ass_benchmarks/log/log_time_chain_compare_simp_code_prefined_cpu_new/"
    ...
    time_complicate_bench_dir = util.data_root + "lab_performance/multi_ass_benchmarks/code/time_complicated_code_prefined_cpu_new/"
    time_simp_bench_dir = util.data_root + "lab_performance/multi_ass_benchmarks/code/time_simple_code_prefined_cpu_new/"
