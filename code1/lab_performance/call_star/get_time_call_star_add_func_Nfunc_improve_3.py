...
if __name__ == '__main__':
    ...
    log_time_complicate_bench_dir = util.data_root_mv + "lab_performance/call_star_benchmarks/log/log_time_compli_code_prefined_cpu_new_improve/"
    ...
    log_time_simp_bench_dir = util.data_root_mv + "lab_performance/call_star_benchmarks/log/log_time_simp_code_prefined_cpu_new_improve/"
    ...
    time_complicate_bench_dir = util.data_root_mv + "lab_performance/call_star_benchmarks/code/time_complicated_code_prefined_cpu_new_improve/"
    time_simp_bench_dir = util.data_root_mv + "lab_performance/call_star_benchmarks/code/time_simple_code_prefined_cpu_new_improve/"

    # util.mkdirs(time_complicate_bench_dir)
    # util.mkdirs(time_simp_bench_dir)
    bench_time_info_dir=util.data_root_mv + "lab_performance/call_star_benchmarks/bench_time_info_dir_prefined_cpu_new_improve/"
    ...
    for ind,file_name in enumerate(dir_list[offset:]):#9001750
        ...
        # if ind>10:
        #     break
        if file_name!="0_Endflag_10_num_0_lower_1_step_2_subscript_func.py":#"5_ass_const_func.py":#"6_ass_swap_func.py":
            continue
        # if os.path.exists(bench_time_info_dir + file_name[:-3] + ".pkl"):
