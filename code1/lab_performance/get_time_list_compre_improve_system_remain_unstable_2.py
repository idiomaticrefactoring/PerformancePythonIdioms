...
if __name__ == '__main__':
    ...
    log_time_complicate_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks/remain_code/log/log_time_list_compreh_compli_code_prefined_cpu/"
    ...
    log_time_simp_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks/remain_code/log/log_time_list_compreh_simp_code_prefined_cpu/"
    ...
    time_complicate_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks/remain_code/code/time_complicated_code_prefined_cpu/"
    time_simp_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks/remain_code/code/time_simple_code_prefined_cpu/"
    ...
    for file_name in dir_list[110:220]:
