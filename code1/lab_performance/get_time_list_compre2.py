...
if __name__ == '__main__':
    ...
    log_time_complicate_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks/code_base/log/log_time_list_compreh_compli_code/"
    log_time_simp_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks/code_base/log/log_time_list_compreh_simp_code/"
    # util.mkdirs(log_time_complicate_bench_dir)
    # util.mkdirs(log_time_simp_bench_dir)
    time_complicate_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks/code_base/code/time_complicated_code/"
    time_simp_bench_dir = util.data_root + "lab_performance/list_compre_benchmarks/code_base/code/time_simple_code/"

    # util.mkdirs(time_complicate_bench_dir)
    # util.mkdirs(time_simp_bench_dir)
    bench_time_info_dir=util.data_root + "lab_performance/list_compre_benchmarks/code_base/code_time_info/"
    ...
    for file_name in dir_list[141:282]:
        # break
