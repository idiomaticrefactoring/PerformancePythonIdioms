...
if __name__ == '__main__':
    ...
    log_time_complicate_bench_dir = util.data_root_mv + "lab_performance/truth_value_test_benchmarks_add_some/log/log_time_compli_code_prefined_cpu_new/"
    ...
    log_time_simp_bench_dir = util.data_root_mv + "lab_performance/truth_value_test_benchmarks_add_some/log/log_time_simp_code_prefined_cpu_new/"
    ...
    time_complicate_bench_dir = util.data_root_mv + "lab_performance/truth_value_test_benchmarks_add_some/code/time_complicated_code_prefined_cpu_new/"
    time_simp_bench_dir = util.data_root_mv + "lab_performance/truth_value_test_benchmarks_add_some/code/time_simple_code_prefined_cpu_new/"

    # util.mkdirs(time_complicate_bench_dir)
    # util.mkdirs(time_simp_bench_dir)
    bench_time_info_dir=util.data_root_mv + "lab_performance/truth_value_test_benchmarks_add_some/bench_time_info_dir_prefined_cpu_new_2/"
    ...
    file_name_list= [
    "()_empty_==_equal_flag_assert_node.py",
    "0.0_empty_!=_equal_flag_while_node.py",
    "0_empty_==_equal_flag_assert_node_func.py",
    "_empty_!=_equal_flag_while_node.py",
    "_empty_==_equal_flag_assert_node.py",
    "0j_empty_==_equal_flag_if_node_func.py"
    ]
    file_name_list = [
        "()_empty_==_equal_flag_assert_node.py",
        "0.0_empty_!=_equal_flag_while_node.py",
    ...
    "0_empty_==_equal_flag_assert_node_func.py",
    "_empty_!=_equal_flag_while_node.py"]
    file_name_list = [ "0_empty_==_equal_flag_assert_node_func.py",
    "_empty_!=_equal_flag_while_node.py"]
    file_name_list = ["_empty_!=_equal_flag_while_node.py"]
    # _empty_ != _equal_flag_while_node
