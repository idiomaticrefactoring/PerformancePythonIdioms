...
def save_one_file_time_list(file_name, code_list):
    for ind, (old_tree, new_tree) in enumerate(code_list):
        ...
        #     continue
        if 1:
            old_content, new_content, flag_same = performance_replace_content_by_ast_time_percounter.replace_content_truth_value_test_insert_time_simple(
                file_path, old_tree, new_tree)
            ...
            print(new_content)
            '''
            new_add_iterations_content = lab_performance_util.insert_iterations_truth_value_test(new_content, iterations)
        ...
        if 1:  # not os.path.exists(time_simp_bench_dir + file_name):
            old_content, new_content, flag_same = performance_replace_content_by_ast_time_percounter.replace_content_truth_value_test_simple(
                file_path, old_tree, new_tree)
            # print("new_content: ")
        ...
        print("all_time_list: ", all_time_list,all_pythonic_time_list)
...
if __name__ == '__main__':
    ...
    log_time_complicate_bench_dir = util.data_root_mv + "lab_performance/truth_value_test_benchmarks/log/log_time_compli_code_prefined_cpu_new/"
    ...
    log_time_simp_bench_dir = util.data_root_mv + "lab_performance/truth_value_test_benchmarks/log/log_time_simp_code_prefined_cpu_new/"
    ...
    time_complicate_bench_dir = util.data_root_mv + "lab_performance/truth_value_test_benchmarks/code/time_complicated_code_prefined_cpu_new/"
    time_simp_bench_dir = util.data_root_mv + "lab_performance/truth_value_test_benchmarks/code/time_simple_code_prefined_cpu_new/"
    ...
    file_name_list = [
                      '()_empty_!=_equal_flag_while_node.pkl', '()_empty_!=_equal_flag_while_node_func.pkl',
        '()_empty_!=_equal_flag_assert_node.pkl', '()_empty_!=_equal_flag_assert_node_func.pkl',
                      '0.0_empty_!=_equal_flag_assert_node.pkl', '0.0_empty_!=_equal_flag_assert_node_func.pkl',
                      '0.0_empty_!=_equal_flag_while_node.pkl', '0.0_empty_!=_equal_flag_while_node_func.pkl',
                      '0_empty_!=_equal_flag_assert_node.pkl', '0_empty_!=_equal_flag_assert_node_func.pkl',
                      '0_empty_!=_equal_flag_while_node.pkl', '0_empty_!=_equal_flag_while_node_func.pkl',
                      '0j_empty_!=_equal_flag_assert_node.pkl', '0j_empty_!=_equal_flag_assert_node_func.pkl',
                      '0j_empty_!=_equal_flag_while_node.pkl', '0j_empty_!=_equal_flag_while_node_func.pkl',
                      'Decimal(0)_empty_!=_equal_flag_assert_node.pkl',
                      'Decimal(0)_empty_!=_equal_flag_assert_node_func.pkl',
                      'Decimal(0)_empty_!=_equal_flag_while_node.pkl',
                      'Decimal(0)_empty_!=_equal_flag_while_node_func.pkl',
                      'False_empty_!=_equal_flag_assert_node.pkl', 'False_empty_!=_equal_flag_assert_node_func.pkl',
                      'False_empty_!=_equal_flag_while_node.pkl', 'False_empty_!=_equal_flag_while_node_func.pkl',
                      'Fraction(0, 1)_empty_!=_equal_flag_assert_node.pkl',
                      'Fraction(0, 1)_empty_!=_equal_flag_assert_node_func.pkl',
                      'Fraction(0, 1)_empty_!=_equal_flag_while_node.pkl',
                      'Fraction(0, 1)_empty_!=_equal_flag_while_node_func.pkl',
                      'None_empty_!=_equal_flag_assert_node.pkl', 'None_empty_!=_equal_flag_assert_node_func.pkl',
                      'None_empty_!=_equal_flag_while_node.pkl', 'None_empty_!=_equal_flag_while_node_func.pkl',
                      '[]_empty_!=_equal_flag_assert_node.pkl', '[]_empty_!=_equal_flag_assert_node_func.pkl',
                      '[]_empty_!=_equal_flag_while_node.pkl', '[]_empty_!=_equal_flag_while_node_func.pkl',
                      '_empty_!=_equal_flag_assert_node.pkl', '_empty_!=_equal_flag_assert_node_func.pkl',
                      '_empty_!=_equal_flag_while_node.pkl', '_empty_!=_equal_flag_while_node_func.pkl',
                      'dict()_empty_!=_equal_flag_assert_node.pkl', 'dict()_empty_!=_equal_flag_assert_node_func.pkl',
                      'dict()_empty_!=_equal_flag_while_node.pkl', 'dict()_empty_!=_equal_flag_while_node_func.pkl',
                      'range(0)_empty_!=_equal_flag_assert_node.pkl',
                      'range(0)_empty_!=_equal_flag_assert_node_func.pkl',
                      'range(0)_empty_!=_equal_flag_while_node.pkl', 'range(0)_empty_!=_equal_flag_while_node_func.pkl',
                      'set()_empty_!=_equal_flag_assert_node.pkl', 'set()_empty_!=_equal_flag_assert_node_func.pkl',
                      'set()_empty_!=_equal_flag_while_node.pkl', 'set()_empty_!=_equal_flag_while_node_func.pkl',
                      '{}_empty_!=_equal_flag_assert_node.pkl', '{}_empty_!=_equal_flag_assert_node_func.pkl',
                      '{}_empty_!=_equal_flag_while_node.pkl', '{}_empty_!=_equal_flag_while_node_func.pkl']

    for ind,file_name in enumerate(dir_list[1:]):#9001750
        # print(file_name)
        # if file_name!='False_empty_!=_equal_flag_while_node_func.py':
        #
        #     continue
        if file_name[:-3]+".pkl" not in file_name_list and "assert" in file_name:
            continue
        ...
        if '.py' not in file_name:
            continue
        code_list = refactor_truth_value_test.refactor_truth_value_test(bench_dir + file_name)
