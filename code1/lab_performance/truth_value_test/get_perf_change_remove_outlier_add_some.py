...
def save_perf_change(file_name,bench_time_info_dir,save_code_info_dir_add_performance_change,invo=50):
    try:
        ...
        lab_code_info.get_performance_improve_info(step=100,remove_outlier=True,factor=3)
...
if __name__ == '__main__':
    ...
    bench_time_info_dir=util.data_root + "lab_performance/truth_value_test_benchmarks/bench_time_info_dir_prefined_cpu_new/"
    ...
    # save_code_info_dir_add_performance_change = \
    #     util.data_root_mv + "lab_performance/truth_value_test_benchmarks_add_some/prefined_cpus_remain_code_new_add_perf_change_remove_oulier_factor_3/"
    ...
    csv_perf_change_dir=util.data_root + "lab_performance/truth_value_test_benchmarks/csv/"
    ...
    run_file_name_list =["0j_empty_==_equal_flag_if_node_func.pkl"]#  ["0j_empty_==_equal_flag_if_node_func.pkl", "None_empty_==_equal_flag_while_node_func.pkl","None_empty_==_equal_flag_if_node_func.pkl"]
    for ind, file_name in enumerate(sorted(os.listdir(bench_time_info_dir)[:])):
        ...
        #     continue
        # if file_name not in run_file_name_list:
        #     continue
    ...
    print("files: ", file_name_list,len(file_name_list), len(exist_file_name_list), len(os.listdir(bench_time_info_dir)))
    print("count of files: ", count)
    # pass
    #'''
    ...
    #'''list_comprehension
    # os.mkdir(csv_perf_change_dir)
    # save_csv_perf_change(save_code_info_dir_add_performance_change, csv_perf_change_dir,csv_file_name="csv_perf_change_result_truth_value_test_remove_outlier.csv")
