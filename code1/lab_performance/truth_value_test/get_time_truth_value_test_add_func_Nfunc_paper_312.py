...
if __name__ == '__main__':
    ...
    log_time_complicate_bench_dir = util.data_root_mv + "lab_performance/truth_value_test_benchmarks_paper/log/log_time_compli_code_prefined_cpu_new/"
    ...
    log_time_simp_bench_dir = util.data_root_mv + "lab_performance/truth_value_test_benchmarks_paper/log/log_time_simp_code_prefined_cpu_new/"
    ...
    time_complicate_bench_dir = util.data_root_mv + "lab_performance/truth_value_test_benchmarks_paper/code/time_complicated_code_prefined_cpu_new/"

    time_simp_bench_dir = util.data_root_mv + "lab_performance/truth_value_test_benchmarks/code/time_simple_code_prefined_cpu_new/"
    time_simp_bench_dir = util.data_root_mv + "lab_performance/truth_value_test_benchmarks_paper/code/time_simple_code_prefined_cpu_new/"
    ...
    bench_time_info_dir=util.data_root_mv + "lab_performance/truth_value_test_benchmarks_paper/bench_time_info_dir_prefined_cpu_new_2/"
    ...
    file_name_list=["0j_empty_==_equal_flag_if_node_func.py"]#["0j_empty_==_equal_flag_if_node_func.py","None_empty_==_equal_flag_while_node_func.py","None_empty_==_equal_flag_if_node_func.py"]
    for ind,file_name in enumerate(dir_list[:]):#9001750
