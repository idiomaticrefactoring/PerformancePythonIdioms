...
def get_features_add_interval(save_code_info_dir_add_performance_change,save_code_info_dir_add_performance_change_remove_outlier):
    ...
    dict_pd = {"file_html":[], "code_str":[],"RCIW":[],"perf_change_right":[],"perf_change_left":[],"perf_change":[],"kind":[],
               "comp_op":[],'node_kind': [],
              'context': [],"is_None":[], "is_False":[], "is_0":[], "is_0.0":[], "is_0j":[], "is_Decimal(0)":[], "is_Fraction(0, 1)":[], "is_empty_string":[], "is_()":[], "is_[]":[], "is_{}":[],
    ...
    for ind, file_name in enumerate(dict_perf_change["file_html"]):
        ...
        dict_empty_set = {"None":"is_None", "False":"is_False", "0":"is_0", "0.0":"is_0.0", "0j":"is_0j", "Decimal(0)":"is_Decimal(0)", "Fraction(0, 1)":"is_Fraction(0, 1)", "empty_string":"is_empty_string", "()":"is_()", "[]":"is_[]", "{}":"is_{}",
        ...
        if "==" in file_name:
            dict_pd["comp_op"].append(1)
        else:
            dict_pd["comp_op"].append(0)
