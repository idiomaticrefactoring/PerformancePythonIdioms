...
if __name__ == '__main__':
    ...
    log_time_complicate_bench_dir = util.data_root + "lab_performance/chain_compare_benchmarks_new/log/log_time_chain_compare_compli_code_prefined_cpu_new/"
    ...
    log_time_simp_bench_dir = util.data_root + "lab_performance/chain_compare_benchmarks_new/log/log_time_chain_compare_simp_code_prefined_cpu_new/"
    ...
    time_complicate_bench_dir = util.data_root + "lab_performance/chain_compare_benchmarks_new/code/time_complicated_code_prefined_cpu_new/"
    time_simp_bench_dir = util.data_root + "lab_performance/chain_compare_benchmarks_new/code/time_simple_code_prefined_cpu_new/"

    # util.mkdirs(time_complicate_bench_dir)
    # util.mkdirs(time_simp_bench_dir)
    bench_time_info_dir=util.data_root + "lab_performance/chain_compare_benchmarks_new/bench_time_info_dir_prefined_cpu_new/"
    ...
    count_remain=0
    for file_name in dir_list[274:]:#9001750
