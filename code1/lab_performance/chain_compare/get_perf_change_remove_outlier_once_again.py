...
if __name__ == '__main__':
    ...
    bench_time_info_dir=util.data_root_mv + "lab_performance/chain_compare_benchmarks_new_2/bench_time_info_dir_prefined_cpu_new/"
    ...
    save_code_info_dir_add_performance_change=\
        util.data_root + "lab_performance/chain_compare_benchmarks/prefined_cpus_remain_code_new_add_perf_change_remove_oulier_factor_3/"
    save_code_info_dir_add_performance_change = \
        util.data_root + "lab_performance/chain_compare_benchmarks_new/prefined_cpus_remain_code_new_add_perf_change_remove_oulier_factor_3/"
    save_code_info_dir_add_performance_change = \
        util.data_root_mv + "lab_performance/chain_compare_benchmarks_new_2/prefined_cpus_remain_code_new_add_perf_change_remove_oulier_factor_3/"
    save_code_info_dir_add_performance_change = \
        util.data_root_mv + "lab_performance/chain_compare_benchmarks_new_3/prefined_cpus_remain_code_new_add_perf_change_remove_oulier_factor_3/"
    ...
    csv_perf_change_dir=util.data_root + "lab_performance/chain_compare_benchmarks/csv/"
    file_name_list=[]
    invo = 50
    count=0
    # file_list=os.listdir(save_code_info_dir_add_performance_change+"50/")
    ...
    for ind, file_name in enumerate(sorted(os.listdir(bench_time_info_dir)[:])):
        ...
        #     count+=1
        try:
            lab_code_info = util.load_pkl(save_code_info_dir_add_performance_change+"50/", file_name_no_suffix)
        except:
            file_name_list.append(file_name)
            count += 1
        # if ind>2:
