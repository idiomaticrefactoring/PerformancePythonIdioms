...
if __name__ == '__main__':
    ...
    save_code_info_dir_add_performance_change=\
        util.data_root + "lab_performance/for_multi_targets_benchmarks/prefined_cpus_remain_code_new_add_perf_change_remove_oulier_factor_3/"
    save_code_info_dir_add_performance_change = \
        util.data_root_mv + "lab_performance/for_multi_targets_benchmarks_2_new/prefined_cpus_remain_code_new_add_perf_change_remove_oulier_factor_3/"
    ...
    invo = 50
    count=0
    file_name_save_list=list(os.listdir(save_code_info_dir_add_performance_change + "50/"))
    for ind, file_name in enumerate(sorted(os.listdir(bench_time_info_dir)[:])):
        ...
        #     continue
        if file_name in file_name_save_list:
            continue
