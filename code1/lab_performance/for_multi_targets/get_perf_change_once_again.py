...
if __name__ == '__main__':
    ...
    bench_time_info_dir=util.data_root + "lab_performance/for_multi_targets_benchmarks/bench_time_info_dir_prefined_cpu_new/"
    ...
    save_code_info_dir_add_performance_change=\
        util.data_root + "lab_performance/multi_ass_benchmarks/prefined_cpus_remain_code_new_add_perf_change/"
    save_code_info_dir_add_performance_change = \
        util.data_root + "lab_performance/for_multi_targets_benchmarks/prefined_cpus_remain_code_new_add_perf_change/"
    save_code_info_dir_add_performance_change = \
        util.data_root_mv + "lab_performance/for_multi_targets_benchmarks_2_new/prefined_cpus_remain_code_new_add_perf_change/"
    ...
    csv_perf_change_dir=util.data_root + "lab_performance/for_multi_targets_benchmarks/csv/"
    file_name_list=[]
    invo = 50
    count=0
    for ind, file_name in enumerate(sorted(os.listdir(bench_time_info_dir)[:])):
        ...
        # break
        # if file_namget_perf_change.pye!="5_ass_const_func.pkl":#"6_ass_swap_func.py":
        #     continue
    ...
    save_csv_perf_change(save_code_info_dir_add_performance_change+str(invo)+"/", csv_perf_change_dir,csv_file_name="csv_perf_change_result_multi_ass.csv")
