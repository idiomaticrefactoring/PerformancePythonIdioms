...
if __name__ == '__main__':
    ...
    for file_name in dir_list[:]:  # 9001750
        if file_name!="1_flag_1_input_2_dim_3_unpack_2_subscript_2_uniqueUnpack_func.py":#"4_not in_not in_not in_not in_not in.py":#"5_<=_>=_==_not in_is.py":#"0_!=_!=_<_not in_is_func.py":#"0_!=_!=_!=_!=_!=_func.py":
            continue
