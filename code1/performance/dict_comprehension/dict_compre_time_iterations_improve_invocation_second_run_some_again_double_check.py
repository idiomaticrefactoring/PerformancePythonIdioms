...
if __name__ == '__main__':
    ...
    save_code_info_dir = util.data_root_mv + "performance/a_dict_comprehension_some_again_double_check/dict_comprehension_iter_invoca_2/"
    time_out_dir = util.data_root_mv + "performance/a_dict_comprehension_some_again_double_check/time_out_record_dir2_/"
    ...
    error_code_dir = util.data_root_mv + "performance/a_dict_comprehension_some_again_double_check/erro_record_dir_2/"
