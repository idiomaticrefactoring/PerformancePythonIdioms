...
if __name__ == '__main__':
    ...
    for ind_code, code in enumerate(code_info_list[:end]):
        ...
        # code.set_run_test_res_compli_code(all_invocations_res)
            ...
            #     break
        print("time_list: ",len(all_invocations_time_list),all_invocations_time_list)
        ...
        print("time_list: ",len(all_invocations_time_list_pythonic),all_invocations_time_list_pythonic)
