        ...
        for test_html, each_rela_path, cl, me in test_me_inf_list:
            ...
            if not is_own_config:
                ...
                run_test_result_new = configure_pro_envir_util.run_test_file_capture_output_each_fun(test_html,
                                                                                                     ...
                                                                                                     prefine_cpus=prefine_cpus,
                                                                                                     iterations=iterations)
            print(f">>>>>>>>>>{(test_html, each_rela_path, cl, me)} {fun_list} run_test_result_new: ")#, run_test_result_new)#, run_test_result_new)
            ...
            if invo == 0 and not is_pythonic_timeflag:
                get_num_add_ele_list = performance_util.get_num_add_ele_two_dimen(run_test_result_new)
                print("get_num_add_ele_list: ",len(get_num_add_ele_list),len(get_num_add_ele_list)% iterations)
            ...
            total_num_ele_list = [[] for i in range(test_case_num)]
            ...
            for i in range(test_case_num):
                for j in range(iterations):
                    ...
                    if invo == 0 and not is_pythonic_timeflag:
                        total_num_ele_list[i].append(get_num_add_ele_list[test_case_num * j + i])
            ...
            all_test_case_time_list[(test_html, each_rela_path, cl, me)] = total_time_list
            if invo == 0 and not is_pythonic_timeflag:
                num_add_ele_list[(test_html, each_rela_path, cl, me)] = total_num_ele_list
...
if __name__ == '__main__':
    ...
    save_code_info_dir=util.data_root_mv+"performance/a_dict_comprehension/dict_comprehension_iter_invoca_2/"
    time_out_dir=util.data_root_mv + "performance/a_dict_comprehension/time_out_record_dir2_/"
    ...
    error_code_dir = util.data_root_mv + "performance/a_dict_comprehension/erro_record_dir_2/"
    ...
    # threshold = 1#10
    # iterations = 2#15
    prefine_cpus=" "#"taskset -c 4,5 "
    offset = 34
    end=67
    '''
    >>>>>>>>>it does not have total_time_list_info_dict_merge
total_time_list_info_dict:  dict_keys([]) https://github.com/mitre/caldera/tree/master/app/api/v2/managers/config_api_manager.py [['https://github.com/mitre/caldera/tree/master/tests/api/v2/managers/test_config_api_manager.py', 'tests.api.v2.managers.test_config_api_manager', '', 'test_filter_keys']]
total_time_list_info_dict:  dict_keys([]) https://github.com/waditu/czsc/tree/master/czsc/utils/echarts_plot.py [['https://github.com/waditu/czsc/tree/master/test/test_analyze.py', 'test.test_analyze', '', 'test_czsc_update']]
total_time_list_info_dict:  dict_keys([('https://github.com/docker/docker-py/tree/master/tests/unit/models_services_test.py', 'tests.unit.models_services_test', 'CreateServiceKwargsTest', 'test_get_create_service_kwargs')]) https://github.com/docker/docker-py/tree/master/docker/models/services.py [['https://github.com/docker/docker-py/tree/master/tests/unit/models_services_test.py', 'tests.unit.models_services_test', 'CreateServiceKwargsTest', 'test_get_create_service_kwargs']]
total_time_list_info_dict:  dict_keys([('https://github.com/cloud-custodian/cloud-custodian/tree/master/tests/test_provider.py', 'tests.test_provider', 'ProviderTest', 'test_import_resource_classes')])>>>>>>>>>it does not have total_time_list_info_dict_merge
 https://github.com/cloud-custodian/cloud-custodian/tree/master/c7n/provider.py [['https://github.com/cloud-custodian/cloud-custodian/tree/master/tests/test_provider.py', 'tests.test_provider', 'ProviderTest', 'test_import_resource_classes']]
 total_time_list_info_dict:  dict_keys([('https://github.com/in-toto/in-toto/tree/master/tests/test_common_args.py', 'tests.test_common_args', 'TestArgparseActionGroupHelpers', 'test_sort_action_groups')]) https://github.com/in-toto/in-toto/tree/master/in_toto/common_args.py [['https://github.com/in-toto/in-toto/tree/master/tests/test_common_args.py', 'tests.test_common_args', 'TestArgparseActionGroupHelpers', 'test_sort_action_groups']]
 total_time_list_info_dict:  dict_keys([]) https://github.com/Yelp/detect-secrets/tree/master/detect_secrets/core/plugins/util.py [['https://github.com/Yelp/detect-secrets/tree/master/tests/core/usage/scan_usage_test.py', 'tests.core.usage.scan_usage_test', '', 'test_default_plugins_initialized'], ['https://github.com/Yelp/detect-secrets/tree/master/tests/core/usage/scan_usage_test.py', 'tests.core.usage.scan_usage_test', '', 'test_force_use_all_plugins'], ['https://github.com/Yelp/detect-secrets/tree/master/tests/plugins/base_test.py', 'tests.plugins.base_test', '', 'test_ensure_all_plugins_have_unique_secret_types'], ['https://github.com/Yelp/detect-secrets/tree/master/tests/core/usage/baseline_usage_test.py', 'tests.core.usage.baseline_usage_test', '', 'test_baseline_optional']]
 total_time_list_info_dict: >>>>>>>>>it does not have total_time_list_info_dict_merge dict_keys([('https://github.com/docker/docker-py/tree/master/tests/unit/models_services_test.py', 'tests.unit.models_services_test', 'CreateServiceKwargsTest', 'test_get_create_service_kwargs')]) https://github.com/docker/docker-py/tree/master/docker/models/services.py [['https://github.com/docker/docker-py/tree/master/tests/unit/models_services_test.py', 'tests.unit.models_services_test', 'CreateServiceKwargsTest', 'test_get_create_service_kwargs']]
 total_time_list_info_dict:  dict_keys([]) https://github.com/mne-tools/mne-python/tree/master/mne/cov.py [['https://github.com/mne-tools/mne-python/tree/master/mne/tests/test_proj.py', 'mne.tests.test_proj', '', 'test_bad_proj'], ['https://github.com/mne-tools/mne-python/tree/master/mne/tests/test_cov.py', 'mne.tests.test_cov', '', 'test_whiten_evoked'], ['https://github.com/mne-tools/mne-python/tree/master/mne/tests/test_cov.py', 'mne.tests.test_cov', '', 'test_cov_order'], ['https://github.com/mne-tools/mne-python/tree/master/mne/tests/test_cov.py', 'mne.tests.test_cov', '', 'test_regularize_cov'], ['https://github.com/mne-tools/mne-python/tree/master/mne/simulation/tests/test_evoked.py', 'mne.simulation.tests.test_evoked', '', 'test_rank_deficiency']]
    '''
    for ind_code,code in enumerate(code_info_list[:]):
        ...
        # if file_html!="https://github.com/mitre/caldera/tree/master/app/api/v2/managers/config_api_manager.py":
        #     continue
        ...
        print(f">>>>>>>>>>>>>>>> total_name of {ind_code} code: ", file_html,cl, me_name, total_name,remove_ass_flag,code.own_config)
        flag_total_test_html = dict()
        flag_total_test_html_instances = dict()
        ...
        #'''
        # print("old_tree: ",for_node.lineno,ast.unparse(for_node))
        ...
        old_content, new_content, flag_same =performance_replace_content_by_ast_time_percounter.replace_file_content_for_compre_3_category_insert_time_complete(old_path,for_node,
                assign_node,
                new_tree, remove_ass_flag,me_name)
        # print(old_content)
        if flag_same:
        ...
        all_test_case_time_list_old, all_valid_flag, dict_run_test_complicated = code_test_get_time(repo_path,
                                                                                                    old_path,
                                                                                                    old_content,
                                                                                                    test_me_inf_list,is_pythonic_timeflag=0,is_own_config=code.own_config,
                                                                                                    iterations=1,
                                                                                                    invo=0,
        ...
        for key_e in all_test_case_time_list_old:
            ...
            continue
        if one_invo_end - one_invo_start > 10:
            print("the test case run too long ", one_invo_end - one_invo_start)
            time_out_list_filter.append([ind_code,ind_code+offset, "complicated code", file_html, cl, me_name, total_name,total_name + "_" + str(ind_code + offset)])
            time_out_flag = 1
            continue
        ...
        if flag_same:
            ...
            case_is_true_list_filter.append([ind_code,ind_code+offset, "pythonic code", file_html, cl, me_name, total_name])
            continue
        ...
        print(len(all_invocations_time_list),all_invocations_time_list)#,flag_total_test_html,flag_total_test_html_instances)
        print(len(all_invocations_time_list_pythonic))#, flag_total_test_html_pythonic, flag_total_test_html_instances_pythonic)
    ...
    util.save_pkl(time_out_dir, "time_out_code_info_2", time_out_list_filter)
    util.save_pkl(error_code_dir, "error_code_is_true_info_2", case_is_true_list_filter)
    pro_time_end = time.time()
    print("total running time of the program: ", pro_time_end - pro_time_start)
    #'''
