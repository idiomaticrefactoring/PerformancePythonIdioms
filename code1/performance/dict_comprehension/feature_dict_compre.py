...
def get_features_add_interval(save_code_info_dir_add_performance_change,save_code_info_dir_add_performance_change_remove_outlier):
    ...
    for file_name in sorted(os.listdir(save_code_info_dir_add_performance_change)):
        ...
        if file_html=="https://github.com/networkx/networkx/tree/master/networkx/generators/joint_degree_seq.py":
            continue
...
if __name__ == '__main__':
    ...
    dir_csv_feature = util.data_root_mv + "performance/a_dict_comprehension/csv/"
    csv_feature_file_name_corr = dir_csv_feature + "train_data_dict_compre.csv"
    csv_feature_file_name_corr = dir_csv_feature + "train_data_dict_compre_no_graph.csv"
    ...
    df_sample = dataMain.sample(n=130, random_state=2022)
    for i in range(1,2):
        pass
    ...
    # df_sample.to_csv(dir_csv_feature + "sample_dict_compre_no_graph.csv", index=False)
