...
if __name__ == '__main__':
    ...
    save_code_info_dir=util.data_root_mv+"performance/a_dict_comprehension/dict_comprehension_iter_invoca/"
    time_out_dir=util.data_root_mv + "performance/a_dict_comprehension/time_out_record_dir/"
    ...
    error_code_dir = util.data_root_mv + "performance/a_dict_comprehension/erro_record_dir/"
    ...
    for ind_code,code in enumerate(code_info_list[offset:end]):
        ...
        # code.set_run_test_res_compli_code(all_invocations_res)
            ...
            #     break
        print("all_test_case_time_list_old: ",all_test_case_time_list_old)
