...
def save_perf_change(file_name,merge,bench_time_info_dir,save_code_info_dir_add_performance_change):
    ...
    lab_code_info.get_performance_improve_info(total_time_list_info_dict=dict(), invocations=50, steps=100,merge=merge)
    # print("performance change: ",lab_code_info.total_time_list_info_dict_merge)
...
if __name__ == '__main__':
    ...
    bench_time_info_dir=util.data_root_mv + "performance/a_truth_value_test/a_truth_value_test_iter_invoca_complete/"
    bench_time_info_dir=util.data_root_mv+"performance/a_truth_value_test/a_truth_value_test_iter_invoca_total_data/"
    bench_time_info_dir=util.data_root_mv+"performance/a_set_comprehension/set_comprehension_iter_invoca/"
    bench_time_info_dir=util.data_root_mv+"performance/a_dict_comprehension/dict_comprehension_iter_invoca/"
    bench_time_info_dir = util.data_root_mv + "performance/a_dict_comprehension/dict_comprehension_iter_invoca_2/"
    bench_time_info_dir = util.data_root_mv + "performance/a_dict_comprehension_some_again_double_check/dict_comprehension_iter_invoca_2/"
    bench_time_info_dir = util.data_root_mv + "performance/a_dict_comprehension_some_again_double_check_add_iterations/dict_comprehension_iter_invoca_2/"

    save_code_info_dir_add_performance_change=util.data_root_mv + "performance/a_set_comprehension/a_set_comprehension_iter_invoca_add_perf_change_new/"

    save_code_info_dir_add_performance_change=util.data_root_mv + "performance/a_dict_comprehension/a_dict_comprehension_iter_invoca_add_perf_change_new_merge/"
    save_code_info_dir_add_performance_change=util.data_root_mv + "performance/a_dict_comprehension/a_dict_comprehension_iter_invoca_add_perf_change_new_merge_2_add_ele/"
    save_code_info_dir_add_performance_change=util.data_root_mv + "performance/a_dict_comprehension_some_again_double_check/a_dict_comprehension_iter_invoca_add_perf_change_new_merge_2_add_ele/"
    save_code_info_dir_add_performance_change=util.data_root_mv + "performance/a_dict_comprehension_some_again_double_check_add_iterations/a_dict_comprehension_iter_invoca_add_perf_change_new_merge_2_add_ele/"

    csv_perf_change_dir=util.data_root + "performance/a_dict_comprehension/csv/"
    file_name_list=[]
    for ind, file_name in enumerate(sorted(os.listdir(bench_time_info_dir)[:])):
        # break
        # if "519" not in file_name:
        #     continue
        # print("come here")
