...
if __name__ == '__main__':
    ...
    save_code_info_dir = util.data_root_mv + "performance/a_call_star_single_2_add_size/a_call_star_iter_invoca_2/"
    error_code_dir = util.data_root_mv + "performance/a_call_star_single_2_add_size/erro_record_dir_2/"
    time_out_dir = util.data_root_mv + "performance/a_call_star_single_2_add_size/time_out_record_dir_2/"
    ...
    for ind_code,code in enumerate(code_info_list[:]):
        ...
        #
        old_content, new_content, flag_same = performance_replace_content_by_ast_call_star.replace_content_var_unpack_call_star_insert_time_add_len(#replace_content_var_unpack_call_star_insert_time(
