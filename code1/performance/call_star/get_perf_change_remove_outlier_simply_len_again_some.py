...
if __name__ == '__main__':
    ...
    save_code_info_dir_add_performance_change=util.data_root_mv + "performance/a_call_star_single_2/a_call_star_single_iter_invoca_add_perf_change_new_merge_remove_outlier_2_new/"
    save_code_info_dir_add_performance_change=util.data_root_mv + "performance/a_call_star_single_3_simplify_len/a_call_star_single_iter_invoca_add_perf_change_new_merge_remove_outlier_2_new/"
    save_code_info_dir_add_performance_change=util.data_root_mv + "performance/a_call_star_single_3_simplify_len_again/a_call_star_single_iter_invoca_add_perf_change_new_merge_remove_outlier_2_new/"
    save_code_info_dir_add_performance_change=util.data_root_mv + "performance/a_call_star_single_4_simplify_len_again_2/a_call_star_single_iter_invoca_add_perf_change_new_merge_remove_outlier_2_new/"
