...
if __name__ == '__main__':
    ...
    for ind_code,code in enumerate(code_info_list[:]):
        # if ind_code not in [23,24,58,63,77]:
        #     continue
        one_code_time_start = time.time()
        code:code_info.CodeInfo
        file_html=code.file_html
        if file_html!="https://github.com/gugarosa/opytimizer/tree/master/opytimizer/visualization/surface.py":
            continue
