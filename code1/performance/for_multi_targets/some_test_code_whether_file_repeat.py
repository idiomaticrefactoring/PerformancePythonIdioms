...
if __name__ == '__main__':
    ...
    file_name = "for_multi_tar_complete"
    ...
    for ind_code,code in enumerate(code_info_list[:28]):
        # if ind_code>0:
        #     break
    ...
    for ind_code,code in enumerate(code_info_list[28:55]):
        # if ind_code>0:
        #     break
        code:code_info.CodeInfo
        file_html=code.file_html
    ...
    for ind_code,code in enumerate(code_info_list[55:85]):
        # if ind_code>0:
        #     break
        code:code_info.CodeInfo
        file_html=code.file_html
