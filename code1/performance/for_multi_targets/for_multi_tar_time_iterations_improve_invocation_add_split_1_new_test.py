...
if __name__ == '__main__':
    ...
    save_code_info_dir=util.data_root_mv+"performance/a_for_multi_tar/a_for_multi_tar_iter_invoca/"
    error_code_dir = util.data_root_mv + "performance/a_for_multi_tar/erro_record_dir/"
    time_out_dir=util.data_root_mv + "performance/a_for_multi_tar/time_out_record_dir/"
    ...
    for ind_code,code in enumerate(code_info_list[:]):#end
        if ind_code not in [i+10 for i in range(5)]:#!=0:
            continue
        # if ind_code not in [i+10 for i in range(10)]:#[i+10 for i in range(10)]:[58]:#
        #     continue
