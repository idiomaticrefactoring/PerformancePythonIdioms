...
if __name__ == '__main__':
    ...
    error_code_dir = util.data_root_mv + "performance/a_for_multi_tar_single_2_unpack_ele_len_new/erro_record_dir_2/"
    time_out_dir = util.data_root_mv + "performance/a_for_multi_tar_single_2_unpack_ele_len_new/time_out_record_dir_2/"
