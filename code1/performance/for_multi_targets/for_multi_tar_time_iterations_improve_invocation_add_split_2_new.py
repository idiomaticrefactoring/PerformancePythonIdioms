...
if __name__ == '__main__':
    ...
    save_code_info_dir = util.data_root_mv + "performance/a_for_multi_tar_single/a_for_multi_tar_iter_invoca/"
    error_code_dir = util.data_root_mv + "performance/a_for_multi_tar_single/erro_record_dir/"
    time_out_dir = util.data_root_mv + "performance/a_for_multi_tar_single/time_out_record_dir/"
    ...
    for ind_code,code in enumerate(code_info_list[offset:end]):
        ...
        # print("**************************************************",new_code_list_simplify,ast.unparse(new_tree_simplify))
