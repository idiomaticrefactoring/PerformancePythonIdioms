...
def code_test_get_time(repo_path, old_path, old_content, test_me_inf_list, is_pythonic_timeflag=0, is_own_config=0,
    ...
    try:
        ...
        for test_html, each_rela_path, cl, me in test_me_inf_list:
            ...
            print("get_time_list: ", len(get_time_list), len(get_time_list) % iterations,num_ele_list)
...
if __name__ == '__main__':
    ...
    save_code_info_dir = util.data_root_mv + "performance/a_for_multi_tar_single_add_size_new/a_for_multi_tar_iter_invoca_2/"
    error_code_dir = util.data_root_mv + "performance/a_for_multi_tar_single_add_size_new/erro_record_dir_2/"
    time_out_dir = util.data_root_mv + "performance/a_for_multi_tar_single_add_size_new/time_out_record_dir_2/"
    ...
    for ind_code,code in enumerate(code_info_list[offset:end]):
        ...
        #     print("new_tree: ",ast.unparse(new_tree))
        #
        # print("lineno: ",old_tree.lineno,ast.unparse(old_tree),ast.unparse(new_tree))
        # '''
        old_content, new_content, flag_same = performance_replace_content_by_ast_for_multi_targets.replace_content_var_unpack_for_target_insert_time_add_size(
