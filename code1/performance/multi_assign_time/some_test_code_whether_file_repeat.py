...
if __name__ == '__main__':
    ...
    file_name = "multi_ass_sample_317"#"multi_ass_sample_317_20"#"multi_ass_sample_317_2021"#"multi_ass_sample_317"
    ...
    for ind_code,code in enumerate(code_info_list[:105]):
        # if ind_code>0:
        #     break
    ...
    for ind_code,code in enumerate(code_info_list[105:212]):
        # if ind_code>0:
        #     break
        code:code_info.CodeInfo
        file_html=code.file_html
    ...
    for ind_code,code in enumerate(code_info_list[212:317]):
        # if ind_code>0:
        #     break
        code:code_info.CodeInfo
        file_html=code.file_html
    ...
    print("intersect: ",len(set(file_html_1)&set(file_html_2)),len(set(file_html_2)&set(file_html_3)))