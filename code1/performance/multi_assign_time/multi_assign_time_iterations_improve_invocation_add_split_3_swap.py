...
if __name__ == '__main__':
    ...
    save_code_info_dir=util.data_root+"performance/a_multi_assign_swap/a_multi_assign_iter_invoca/"
    error_code_dir = util.data_root + "performance/a_multi_assign_swap/erro_record_dir/"
    time_out_dir=util.data_root + "performance/a_multi_assign_swap/time_out_record_dir/"
