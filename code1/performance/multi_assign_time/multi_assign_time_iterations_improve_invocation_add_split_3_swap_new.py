...
def code_test_get_time(repo_path, old_path, old_content, test_me_inf_list, is_pythonic_timeflag=0, is_own_config=0,
    ...
    try:
        ...
        for test_html, each_rela_path, cl, me in test_me_inf_list:
            ...
            print("get_time_list: ",len(get_time_list),len(get_time_list)% iterations)#get_time_list,
...
if __name__ == '__main__':
    ...
    save_code_info_dir=util.data_root+"performance/a_multi_assign_swap_new/a_multi_assign_iter_invoca/"
    error_code_dir = util.data_root + "performance/a_multi_assign_swap_new/erro_record_dir/"
    time_out_dir=util.data_root + "performance/a_multi_assign_swap_new/time_out_record_dir/"
    ...
    for ind_code,code in enumerate(code_info_list[:]):
        ...
        # print(old_tree,new_tree,ast.unparse(new_tree),new_tree.lineno)
        old_content, new_content, flag_same = performance_replace_content_by_ast_multi_assign.replace_content_multi_ass_insert_time_swap_vars(
        ...
        print(f"all_test_case_time_list_old: ",all_test_case_time_list_old)
        ...
        # old_content, new_content, flag_same = performance_replace_content_by_ast_multi_assign.replace_content_multi_ass(
        #     old_path, old_tree, new_tree, me_name)
        old_content, new_content, flag_same = performance_replace_content_by_ast_multi_assign.replace_content_multi_ass_swap(
            old_path, old_tree, new_tree, me_name)
        if flag_same:
