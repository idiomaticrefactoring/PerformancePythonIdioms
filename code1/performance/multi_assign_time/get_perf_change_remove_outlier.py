...
def save_perf_change(file_name,merge,bench_time_info_dir,save_code_info_dir_add_performance_change):
    ...
    lab_code_info.get_performance_improve_info(total_time_list_info_dict=dict(), invocations=50, steps=100,merge=merge,remove_outlier=True)
...
if __name__ == '__main__':
    ...
    bench_time_info_dir=util.data_root+"performance/a_multi_assign_swap/a_multi_assign_iter_invoca/"
    bench_time_info_dir=util.data_root+"performance/a_multi_assign_swap_new/a_multi_assign_iter_invoca/"
    bench_time_info_dir=util.data_root+"performance/a_multi_assign_swap_new/a_multi_assign_iter_invoca/"

    save_code_info_dir_add_performance_change=util.data_root_mv + "performance/a_multi_assign/a_multi_assign_iter_invoca_add_perf_change_new_remove_outlier/"

    save_code_info_dir_add_performance_change=util.data_root_mv + "performance/a_multi_assign/a_multi_assign_iter_invoca_add_perf_change_new_remove_outlier_merge/"
    ...
    for ind, file_name in enumerate(sorted(os.listdir(bench_time_info_dir)[:])):
        ...
        lab_code_info = util.load_pkl(bench_time_info_dir, file_name[:-4])
        print(lab_code_info.simple_code_time_dict)
        save_perf_change(file_name,1,bench_time_info_dir,save_code_info_dir_add_performance_change)
    #     if ind>2:
    #         break
    # pass
