...
if __name__ == '__main__':
    ...
    save_code_info_dir=util.data_root+"performance/a_multi_assign/a_multi_assign_iter_invoca_once_again/"
    error_code_dir = util.data_root + "performance/a_multi_assign/erro_record_dir_once_again/"
    time_out_dir=util.data_root + "performance/a_multi_assign/time_out_record_dir_once_again/"
