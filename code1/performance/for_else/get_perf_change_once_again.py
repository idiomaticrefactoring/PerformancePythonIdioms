...
def copy_data():
    bench_time_info_dir_2 = util.data_root_mv + "performance/a_for_else/a_for_else_tar_iter_invoca_2/"
...
if __name__ == '__main__':
    ...
    bench_time_info_dir = util.data_root_mv + "performance/a_for_else/a_for_else_tar_iter_invoca_2_once_again/"


    save_code_info_dir_add_performance_change=util.data_root_mv + "performance/a_for_multi_tar/a_for_multi_tar_iter_invoca_add_perf_change_new/"

    save_code_info_dir_add_performance_change=util.data_root_mv + "performance/a_for_else/a_for_else_iter_invoca_add_perf_change_new_merge/"
    ...
    save_code_info_dir_add_performance_change=util.data_root_mv + "performance/a_for_else/a_for_else_iter_invoca_add_perf_change_new_merge_2_once_again/"
