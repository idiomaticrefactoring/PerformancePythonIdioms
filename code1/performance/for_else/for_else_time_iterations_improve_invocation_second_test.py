...
if __name__ == '__main__':
    ...
    save_code_info_dir = util.data_root_mv + "performance/a_for_else/a_for_else_tar_iter_invoca_2/"
    error_code_dir = util.data_root_mv + "performance/a_for_else/erro_record_dir_2/"
    time_out_dir = util.data_root_mv + "performance/a_for_else/time_out_record_dir_2/"
    no_time_dir = util.data_root_mv + "performance/a_for_else/no_time_record_dir_2/"
    ...
    for ind_code, code in enumerate(code_info_list[:]):
        ...
        print("if: ",ast.unparse(if_varnode))
        old_content, new_content, flag_same = performance_replace_content_by_ast_for_else.replace_content_for_else_insert_time(
