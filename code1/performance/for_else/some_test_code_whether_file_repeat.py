...
if __name__ == '__main__':
    ...
    for ind_code,code in enumerate(code_info_list[:19]):
        # if ind_code>0:
        #     break
    ...
    for ind_code,code in enumerate(code_info_list[55:86]):
        # if ind_code>0:
        #     break
        code:code_info.CodeInfo
        file_html=code.file_html
    ...
    print("intersect: ",set(file_html_1),set(file_html_2),set(file_html_1)&set(file_html_2),set(file_html_2)&set(file_html_3),set(file_html_3))