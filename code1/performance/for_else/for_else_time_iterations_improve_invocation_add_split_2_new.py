...
if __name__ == '__main__':
    ...
    save_code_info_dir = util.data_root_mv + "performance/a_for_else/a_for_else_tar_iter_invoca/"
    error_code_dir = util.data_root_mv + "performance/a_for_else/erro_record_dir/"
    time_out_dir = util.data_root_mv + "performance/a_for_else/time_out_record_dir/"
    no_time_dir = util.data_root_mv + "performance/a_for_else/no_time_record_dir/"
    ...
    util.save_pkl(no_time_dir, "no_time_code_info_2", no_time_list)
