...
if __name__ == '__main__':
    ...
    for ind_code,code in enumerate(code_info_list[:156]):#code_info_list[:102]
        # if ind_code>0:
        #     break
    ...
    for ind_code,code in enumerate(code_info_list[156:309]):#code_info_list[102:207]
        # if ind_code>0:
        #     break
        code:code_info.CodeInfo
        file_html=code.file_html
    ...
    # for ind_code,code in enumerate(code_info_list[207:309]):
    #     # if ind_code>0:
    #     #     break
    #     code:code_info.CodeInfo
    #     file_html=code.file_html
