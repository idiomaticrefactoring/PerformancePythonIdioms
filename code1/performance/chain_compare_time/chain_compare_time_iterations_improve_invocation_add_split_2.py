...
if __name__ == '__main__':
    ...
    for ind_code, code in enumerate(code_info_list[offset:end]):#
        ...
        # if "mlens/mlens/externals/sklearn/base.py" not in file_html:
        #     continue
        # if file_html!="https://github.com/schematics/schematics/tree/master/schematics/transforms.py":#"https://github.com/gugarosa/opytimizer/tree/master/opytimizer/core/node.py":#"https://github.com/nipy/nibabel/tree/master/nibabel/fileslice.py":#"https://github.com/Project-MONAI/MONAI/tree/master/monai/utils/deprecate_utils.py":#"https://github.com/pgmpy/pgmpy/tree/master/pgmpy/independencies/Independencies.py":
        #     continue
