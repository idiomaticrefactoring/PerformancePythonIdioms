...
def save_perf_change(file_name,merge,bench_time_info_dir,save_code_info_dir_add_performance_change):
    ...
    lab_code_info.get_performance_improve_info(total_time_list_info_dict=dict(), invocations=invo, steps=100,merge=merge,remove_outlier=True)
...
if __name__ == '__main__':
    ...
    bench_time_info_dir_new=util.data_root_mv + "performance/chain_compare/chain_compare_iter_invoca_new/50/"
    ...
    too_large_file=['toolz.itertoolz.join_25','toolz.itertoolz.join_26']

    filter_file_name=time_out_list_filter+case_is_true_list_filter+time_out_list_filter_2+case_is_true_list_filter_2+too_large_file
    ...
    #         break
    # pass
    print("total file name: ",len(file_name_list),filter_num)
    #'''

    merge_list, bench_time_info_dir_list, save_code_info_dir_add_performance_change_list=\
        [1 for i in range(len(file_name_list))],[bench_time_info_dir_new for i in range(len(file_name_list))],[save_code_info_dir_add_performance_change for i in range(len(file_name_list))]
