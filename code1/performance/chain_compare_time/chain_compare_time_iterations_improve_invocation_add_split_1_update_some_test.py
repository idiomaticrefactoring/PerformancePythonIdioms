...
if __name__ == '__main__':
    ...
    # threshold = 1#10
    # iterations = 2#15
    file_html_check=['https://github.com/petertodd/python-bitcoinlib/tree/master/bitcoin/segwit_addr.py',
                     'https://github.com/pydicom/pydicom/tree/master/pydicom/filereader.py']
    test_info=('https://github.com/petertodd/python-bitcoinlib/tree/master/bitcoin/tests/test_bech32.py',
               'bitcoin.tests.test_bech32', 'Test_bech32', 'test_encode_decode')
    # ('https://github.com/pydicom/pydicom/tree/master/pydicom/tests/test_rawread.py', 'pydicom.tests.test_rawread',
    #  'TestRawSequence', 'test_explVR_switch_implVR_in_SQ_item')
    # None is not defer_size and defer_size < length
    # None is not defer_size < length and tag != BaseTag(524293)
    ...
    for ind_code,code in enumerate(code_info_list[:]):
        ...
        if file_html!="https://github.com/nccgroup/ScoutSuite/tree/master/ScoutSuite/core/conditions.py":#"https://github.com/pgmpy/pgmpy/tree/master/pgmpy/independencies/Independencies.py":#'https://github.com/petertodd/python-bitcoinlib/tree/master/bitcoin/segwit_addr.py':#"https://github.com/kellyjonbrazil/jc/tree/master/jc/parsers/csv.py":
            continue
        ...
        if "and " in ast.unparse(new_tree):
            ...
            print(" new_old_code: ", old_tree.lineno,old_tree, ast.unparse(old_tree),"\nnew_new_code: ", new_tree,ast.unparse(new_tree))
        else:
            print(f"existed >>>>>>>>>>>>>>>> existed total_name of {ind_code} code: ", file_html,cl, me_name, total_name)
            continue
            pass
