...
if __name__ == '__main__':
    ...
    # iterations = 2#15
    '''
    >>>>>>>>>>>>>>>> total_name of 4 code:  https://github.com/Project-MONAI/MONAI/tree/master/monai/utils/deprecate_utils.py  deprecated monai.utils.deprecate_utils.deprecated
whether code1 same:  False
*********************invo 0*********************************
>>>>>>>>>>>>>>>cmd_test:  echo '*************************test*************************' ; cd /mnt/zejun/smp/data/python_star_2000repo/MONAI/ ; pip3 install pytest-flakefinder;taskset -c 6,7  python3.7 -m pytest --flake-finder --flake-runs=35 -s -v tests/test_deprecated.py::TestDeprecatedRC::test_warning_beyond --cache-clear ; echo '*************************test*************************';
>>>>>>>>>>('https://github.com/Project-MONAI/MONAI/tree/master/tests/test_deprecated.py', 'tests.test_deprecated', 'TestDeprecatedRC', 'test_warning_beyond') ['TestDeprecatedRC::test_warning_beyond'] run_test_result_new: 
>>>>>>>>>>count_test_method:  38
get_time_list:  38 3
    '''
    ...
    for ind_code, code in enumerate(code_info_list[offset:]):
        ...
        print(ast.unparse(old_tree), old_tree.__dict__,ast.unparse(new_tree))
        # '''
