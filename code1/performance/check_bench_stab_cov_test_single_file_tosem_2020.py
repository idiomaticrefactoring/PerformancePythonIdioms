...
if __name__ == '__main__':
    ...
    save_code_info_dir_add_performance_change=util.data_root+"performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_20invo/"# 实际是60
    ...
    save_code_info_dir_add_performance_change=util.data_root+"performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_30invo/"# 实际是90
    ...
    save_code_info_dir_add_performance_change=util.data_root+"performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_30invo_2_tosem_2020/"
    save_code_info_dir_add_performance_change=util.data_root+"performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_30invo_tosem_2020/"
    save_code_info_dir_add_performance_change=util.data_root+"performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_20invo_2_tosem_2020/"
    save_code_info_dir_add_performance_change=util.data_root+"performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_20invo_tosem_2020/"
    save_code_info_dir_add_performance_change = util.data_root + "performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_tosem_2020/"#实际是30
    ...
    save_code_info_dir_add_performance_change = util.data_root + "performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_2_tosem_2020_10invo/"#实际是10
    save_code_info_dir_add_performance_change = util.data_root + "performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_tosem_2020_10invo/"#实际是10
    ...
    bench_time_info_dir_list=[
        "performance/list_compre_benchmarks_iter_improv_final_test/","performance/list_compre_benchmarks_iter_improv_final/","performance/list_compre_benchmarks_new_test_single_file_final/","performance/list_compre_benchmarks_new/","performance/list_compre_benchmarks/"]#code_base
    ...
    for dir_e in bench_time_info_dir_list[:1]:
        ...
        for ind, file_name in enumerate(os.listdir(bench_time_info_dir)[:]):
            ...
            lab_code_info.get_performance_info(total_time_list_info_dict=total_time_list_info_dict,invocations=10)
            '''
            warms_up=3
            window=4
