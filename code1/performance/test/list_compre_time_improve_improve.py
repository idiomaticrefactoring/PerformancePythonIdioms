...
if __name__ == '__main__':
    ...
    save_code_info_dir=util.data_root+"performance/test/list_compre_benchmarks/"
    ...
    for ind_code,code in enumerate(code_info_list[offset:]):
        ...
        if file_html!="https://github.com/kellyjonbrazil/jc/tree/master/jc/parsers/systemctl_ls.py":
            continue
        ...
        # code_info = util.load_pkl(save_code_info_dir, total_name+"_"+str(ind_code+offset))
        # print(code_info.file_html,code_info.flag_total_test_html_pythonic)
        # break
