...
alias( lm(log(perf_change) ~ log(num_ele+1)+log(Var+1)+log(num_param+1)+log(expVar_unique+1)+log(num_loop+1)+log(num_if+1)+log(num_if_else+1)+log(num_var+1)+log(num_List+1)+log(num_Dict+1)+log(num_Tuple+1)+log(num_Subscript+1)+log(num_Attr+1)+log(num_constant+1)+log(num_line+1)+log(num_Operators+1)
           , data=data1) )
