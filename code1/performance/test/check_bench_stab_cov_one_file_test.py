...
if __name__ == '__main__':
    ...
    save_code_info_dir_add_performance_change=util.data_root+"performance/test/list_compre_benchmarks_perf_change/"

    bench_time_info_dir_list=["performance/test/list_compre_benchmarks/"]#code_base
