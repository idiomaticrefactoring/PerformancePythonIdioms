...
def save_features_1(bench_time_info_dir):
        # print("come here")
        perf_change_list=[]
        ...
        for ind, file_name in enumerate(os.listdir(bench_time_info_dir)[:]):
                ...
                count_code += 1
                # print("one_code_num_list: ",one_code_num_list,count_size_of_null)
        return perf_change_list,perf_left_change_list,perf_right_change_list,conf_inter_list
        # print(">>>>>>>>features: ",dict_pd.keys())
        # dataMain = pd.DataFrame(data=dict_pd)
        # print(">>>>>>drop same features: ", dataMain.keys())
        # # print(dataMain.to_dict())
...
if __name__ == '__main__':
        ...
        bench_time_info_dir = util.data_root + "performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_30invo_2_tosem_2020/"
        bench_time_info_dir = util.data_root + "performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_30invo_tosem_2020/"
        bench_time_info_dir = util.data_root + "performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_20invo_2_tosem_2020/"
        bench_time_info_dir = util.data_root + "performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_20invo_tosem_2020/"
        bench_time_info_dir = util.data_root + "performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_2/"
        bench_time_info_dir = util.data_root + "performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_tosem_2020/"
        bench_time_info_dir = util.data_root + "performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_2_tosem_2020_10invo/"  # 实际是10
        bench_time_info_dir = util.data_root + "performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_tosem_2020_10invo/"  # 实际是10
        bench_time_info_dir = util.data_root + "performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_2_tosem_2020_20invo/"  # 实际是10
        bench_time_info_dir = util.data_root + "performance/list_compre_benchmarks_iter_improv_final_add_perf_change_test_tosem_2020_20invo/"  # 实际是10

        time_info_dir_list=["list_compre_benchmarks_iter_improv_final_add_perf_change_test_30invo_2_tosem_2020/",
                            "list_compre_benchmarks_iter_improv_final_add_perf_change_test_30invo_tosem_2020/",# 实际是90
                            "list_compre_benchmarks_iter_improv_final_add_perf_change_test_20invo_2_tosem_2020/",
                        "list_compre_benchmarks_iter_improv_final_add_perf_change_test_20invo_tosem_2020/",# 实际是60
        "list_compre_benchmarks_iter_improv_final_add_perf_change_test_2/",# 实际是30
        "list_compre_benchmarks_iter_improv_final_add_perf_change_test_tosem_2020/",# 实际是30
        "list_compre_benchmarks_iter_improv_final_add_perf_change_test_tosem_2020_20invo/",# 实际是20
        "list_compre_benchmarks_iter_improv_final_add_perf_change_test_2_tosem_2020_20invo/",
        "list_compre_benchmarks_iter_improv_final_add_perf_change_test_2_tosem_2020_10invo/" , # 实际是10
        "list_compre_benchmarks_iter_improv_final_add_perf_change_test_tosem_2020_10invo/"]
        dict_pd=dict()
        for file_name in time_info_dir_list:
                path=util.data_root +"performance/"+file_name
                perf_change_list,perf_left_change_list,perf_right_change_list,conf_inter_list=save_features_1(path)
                dict_pd[file_name+"_perf_change"]=perf_change_list
                dict_pd[file_name + "_perf_left_change"] = perf_left_change_list
                dict_pd[file_name + "_perf_right_change"] = perf_right_change_list
                dict_pd[file_name + "_perf_confi_width"] = conf_inter_list
        dataMain = pd.DataFrame(data=dict_pd)
        # print(dataMain.to_dict())
        dataMain.to_csv("all_perf_change_interval_list_comprehension_invocations.csv", index=False)
