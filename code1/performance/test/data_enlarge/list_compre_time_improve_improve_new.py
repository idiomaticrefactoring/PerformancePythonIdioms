...
if __name__ == '__main__':
    ...
    for for_num in for_num_list:
        ...
        for ind_code, code in enumerate(code_info_list[offset:end]):
            ...
            # if file_html!="https://github.com/kellyjonbrazil/jc/tree/master/jc/parsers/csv.py":#"https://github.com/kellyjonbrazil/jc/tree/master/jc/parsers/systemctl_luf.py":
            #     continue
