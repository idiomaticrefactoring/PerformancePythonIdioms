...
if __name__ == '__main__':
    ...
    for ind_code, code in enumerate(code_info_list[original_offset:end]):
        ...
        print("len(all_invocations_time_list): ",
              len(all_test_case_time_list_old))  # ,flag_total_test_html,flag_total_test_html_instances)
        print("len(all_invocations_time_list_pythonic): ",
              len(type_add_list))  # , flag_total_test_html_pythonic, flag_total_test_html_instances_pythonic)
    ...
    util.save_pkl(error_code_dir, "error_code_is_true_info_complete_2_add_type", case_is_true_list_filter)
    util.save_pkl(time_out_dir, "time_out_code_info_complete_2_add_type", time_out_list_filter)
    util.save_pkl(no_through_code_dir, "no_through_code_info_complete_2_add_type", no_through_code_list)
