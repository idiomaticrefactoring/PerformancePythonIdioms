...
def get_features_add_interval(save_code_info_dir_add_performance_change,save_code_info_dir_add_performance_change_remove_outlier):
    ...
    for file_name in sorted(os.listdir(save_code_info_dir_add_performance_change)):
        ...
        for ind_tm, test_me in enumerate(perf_info_dict):
            ...
            for instance in perf_info_dict[test_me]:
                ...
                dict_pd["RCIW"].append(rciw_one)
                dict_pd["RCIW_rm_outlier"].append(rciw_one_rm
                    )
        print("the len of all_test_instance_perf_list: ",len(all_test_instance_perf_list))
    ...
    dataMain = pd.DataFrame(data=dict_pd, columns=["comp_op", 'node_kind','empty_kind'
        ""])
...
if __name__ == '__main__':
    ...
    csv_feature_file_name_corr= csv_perf_change_dir+"train_data_truth_value_test_category.csv"

    csv_feature_file_name_corr= csv_perf_change_dir+"train_data_truth_value_test_category_remove_redudant.csv"
