...
if __name__ == '__main__':
    ...
    util.save_pkl(error_code_dir, "error_code_is_true_info_add_some", case_is_true_list_filter)
    util.save_pkl(time_out_dir, "time_out_code_info_add_some", time_out_list_filter)
    util.save_pkl(no_through_code_dir, "no_through_code_info_add_some", no_through_code_list)
