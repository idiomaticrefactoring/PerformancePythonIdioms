...
if __name__ == '__main__':
    ...
    file_name="truth_value_test_sample_remain_all"#"multi_ass_complete"
    code_time_list=[]
    ...
    util.save_pkl(error_code_dir, "error_code_is_true_info_add_some_2", case_is_true_list_filter)
    util.save_pkl(time_out_dir, "time_out_code_info_add_some_2", time_out_list_filter)
    util.save_pkl(no_through_code_dir, "no_through_code_info_add_some_2", no_through_code_list)
