...
if __name__ == '__main__':
    ...
    bench_time_info_dir_ass=util.data_root + "performance/a_multi_assign/a_multi_assign_iter_invoca/"
    bench_time_info_dir_ass_swap=util.data_root+"performance/a_multi_assign_swap_new/a_multi_assign_iter_invoca/"

    load_time_info=util.data_root_mv+"performance/total_time_dir/"
    total_time_list={
        "truth_value_test": [bench_time_info_dir_truth_test],
        "assign-multi-targets":[bench_time_info_dir_ass_swap,bench_time_info_dir_ass],
        "":[],
