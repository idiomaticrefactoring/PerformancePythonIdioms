...
if __name__ == '__main__':
    ...
    save_code_info_dir=util.data_root_mv+"performance/a_set_comprehension/set_comprehension_iter_invoca/"
    time_out_dir=util.data_root_mv + "performance/a_set_comprehension/time_out_record_dir/"
