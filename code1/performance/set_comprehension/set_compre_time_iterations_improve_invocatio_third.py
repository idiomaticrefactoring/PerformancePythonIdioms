...
if __name__ == '__main__':
    ...
    save_code_info_dir = util.data_root_mv + "performance/a_set_comprehension_2/set_comprehension_iter_invoca_2/"
    time_out_dir = util.data_root_mv + "performance/a_set_comprehension_2/time_out_record_dir_2/"
    ...
    error_code_dir = util.data_root_mv + "performance/a_set_comprehension_2/erro_record_dir/"
