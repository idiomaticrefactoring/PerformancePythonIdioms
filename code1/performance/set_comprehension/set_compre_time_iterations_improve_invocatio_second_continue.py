...
if __name__ == '__main__':
    ...
    save_code_info_dir = util.data_root_mv + "performance/a_set_comprehension/set_comprehension_iter_invoca_2/"
    time_out_dir = util.data_root_mv + "performance/a_set_comprehension/time_out_record_dir_2/"

    file_dir = util.data_root + "format_code_info/"
    file_name = "set_compre_complete"
    code_time_list = []
    pro_path = util.data_root + "python_star_2000repo/"
    code_info_list = util.load_pkl(file_dir, file_name)
    error_code_dir = util.data_root_mv + "performance/a_set_comprehension/erro_record_dir/"
    ...
    '''
    total_time_list_info_dict:  dict_keys([]) https://github.com/sympy/sympy/tree/master/sympy/ntheory/residue_ntheory.py [['https://github.com/sympy/sympy/tree/master/sympy/ntheory/tests/test_residue.py', 'sympy.ntheory.tests.test_residue', '', 'test_residue']]
    total_time_list_info_dict:  dict_keys([]) https://github.com/nilearn/nilearn/tree/master/nilearn/datasets/func.py [['https://github.com/nilearn/nilearn/tree/master/nilearn/datasets/tests/test_func.py', 'nilearn.datasets.tests.test_func', '', 'test_select_from_index']]
    total_time_list_info_dict:  dict_keys([]) https://github.com/sympy/sympy/tree/master/sympy/combinatorics/testutil.py [['https://github.com/sympy/sympy/tree/master/sympy/combinatorics/tests/test_perm_groups.py', 'sympy.combinatorics.tests.test_perm_groups', '', 'test_normal_closure'], ['https://github.com/sympy/sympy/tree/master/sympy/combinatorics/tests/test_testutil.py', 'sympy.combinatorics.tests.test_testutil', '', 'test_verify_normal_closure']]
    total_time_list_info_dict:  dict_keys([]) https://github.com/sympy/sympy/tree/master/sympy/simplify/radsimp.py [['https://github.com/sympy/sympy/tree/master/sympy/simplify/tests/test_radsimp.py', 'sympy.simplify.tests.test_radsimp', '', 'test_collect_const']]
    total_time_list_info_dict:  dict_keys([]) https://github.com/sympy/sympy/tree/master/sympy/assumptions/facts.py [['https://github.com/sympy/sympy/tree/master/sympy/assumptions/tests/test_query.py', 'sympy.assumptions.tests.test_query', '', 'test_known_facts_consistent']]
    total_time_list_info_dict:  dict_keys([]) https://github.com/buildbot/buildbot/tree/master/master/buildbot/reporters/utils.py [['https://github.com/buildbot/buildbot/tree/master/master/buildbot/test/unit/reporters/test_utils.py', 'master.buildbot.test.unit.reporters.test_utils', 'TestDataUtils', 'test_getResponsibleUsersFromPatch'], ['https://github.com/buildbot/buildbot/tree/master/master/buildbot/test/unit/reporters/test_utils.py', 'master.buildbot.test.unit.reporters.test_utils', 'TestDataUtils', 'test_getResponsibleUsers']]
    total_time_list_info_dict:  dict_keys([]) https://github.com/sympy/sympy/tree/master/sympy/physics/vector/functions.py [['https://github.com/sympy/sympy/tree/master/sympy/physics/vector/tests/test_functions.py', 'sympy.physics.vector.tests.test_functions', '', 'test_express'], ['https://github.com/sympy/sympy/tree/master/sympy/physics/vector/tests/test_frame.py', 'sympy.physics.vector.tests.test_frame', '', 'test_coordinate_vars']]
    total_time_list_info_dict:  dict_keys([]) https://github.com/sympy/sympy/tree/master/sympy/ntheory/residue_ntheory.py [['https://github.com/sympy/sympy/tree/master/sympy/ntheory/tests/test_residue.py', 'sympy.ntheory.tests.test_residue', '', 'test_residue']]
    ...
    for ind_code, code in enumerate(code_info_list[offset:]):
        ...
        # if ind_code>0:
        #     break
        # if ind_code not in [16+i for i in range(10)]:#!=2:
        #     continue
        one_code_time_start = time.time()
        code: code_info.CodeInfo
        file_html = code.file_html
        # if file_html!="https://github.com/sympy/sympy/tree/master/sympy/ntheory/residue_ntheory.py":
        #     continue
        ...
        # print(">>>>>> code info: ",ast.unparse(for_node),for_node.lineno)
        ...
        if one_invo_end - one_invo_start > 15:
            ...
            time_out_flag = 1
            continue
        # print(all_test_case_time_list_old, num_add_ele_list_test_one_iter)
        # break
        # '''
        ...
        for invo in range(invocations):
            ...
            all_test_case_time_list_old, all_valid_flag, dict_run_test_complicated, config_again_flag = code_test_get_time(
                ...
                iterations=iterations, invo=invo, threshhold=threshold,
        ...
        for invo in range(invocations):
            ...
            # util.save_file_path(repo_path + rela_path_test_pythonic,
            #                     new_content)
            all_test_case_time_list_old, all_valid_flag, dict_run_test, config_again_flag = code_test_get_time(
                repo_path, old_path,
                old_content,
                test_me_inf_list, is_pythonic_timeflag=1, is_own_config=code.own_config,
                iterations=iterations, invo=invo,
                threshhold=threshold,
    ...
    util.save_pkl(time_out_dir, "time_out_code_info_continue", time_out_list_filter)
    util.save_pkl(error_code_dir, "error_code_is_true_info_continue", case_is_true_list_filter)
    pro_time_end = time.time()
    print("total running time of the program: ", pro_time_end - pro_time_start)
