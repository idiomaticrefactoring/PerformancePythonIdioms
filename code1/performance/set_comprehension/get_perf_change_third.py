...
def copy_data():
    bench_time_info_dir_2=util.data_root_mv+"performance/a_set_comprehension/set_comprehension_iter_invoca_2/"
...
if __name__ == '__main__':
    ...
    bench_time_info_dir = util.data_root_mv + "performance/a_set_comprehension/set_comprehension_iter_invoca_2/"
    bench_time_info_dir = util.data_root_mv + "performance/a_set_comprehension_2/set_comprehension_iter_invoca_2/"
    ...
    csv_perf_change_dir=util.data_root + "performance/a_set_comprehension/csv/"
    file_name_list=[]
    for ind, file_name in enumerate(sorted(os.listdir(bench_time_info_dir)[:])):
        # break
        # if "519" not in file_name:
